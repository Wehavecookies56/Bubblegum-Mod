...
public class WorldProviderBubblegum extends WorldProvider
{
...
{
return new ChunkProviderBubblegum(this.worldObj, this.worldObj.getSeed(), false);
}
...
{
if ((this instanceof WorldProviderBubblegum))
{
return "Entering The Bubblegum Realm";
}
return null;
}
@SideOnly(Side.CLIENT)
