...
public class Strings {
    ...
    public static final String PG4 = "Pink Bubblegum Bricks";
    
    public static final String BG1 = "Blue Bubblegum";
    public static final String BG2 = "Ornate Blue Bubblegum";
    public static final String BG3 = "Chiseled Blue Bubblegum";
    public static final String BG4 = "Blue Bubblegum Bricks";
    
    public static final String YG1 = "Yellow Bubblegum";
