...
import wehavecookies56.bgm.world.gen.dim.BubblegumTeleporter;
...
public class BlockBGMPortal extends BlockBreakable
{
public BlockBGMPortal(int par1)
{
super(par1, "BGM:BGMPortal", Material.portal, false);
...
byte b0 = 0;
byte b1 = 0;
if (par1World.getBlockId(par2 - 1, par3, par4) == AddedBlocks.BlueGum2.blockID || par1World.getBlockId(par2 + 1, par3, par4) == AddedBlocks.BlueGum2.blockID)
{
b0 = 1;
}
if (par1World.getBlockId(par2, par3, par4 - 1) == AddedBlocks.BlueGum2.blockID || par1World.getBlockId(par2, par3, par4 + 1) == AddedBlocks.BlueGum2.blockID)
{
b1 = 1;
}
if (b0 == b1)
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         if (flag)
         {
         if (j1 != AddedBlocks.BlueGum2.blockID)
         {
         return false;
         }
         }
         else if (j1 != 0 && j1 != AddedBlocks.BGMFire.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, AddedBlocks.BGMPortal.blockID, 0, 2);
}
}
return true;
}
...
if (par1World.getBlockId(par2, i1 - 1, par4) !=AddedBlocks.BlueGum2.blockID)
{
...
if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == AddedBlocks.BlueGum2.blockID)
{
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != AddedDimensions.DIM_ID)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, AddedDimensions.DIM_ID, new BubblegumTeleporter(thePlayer.mcServer.worldServerForDimension(AddedDimensions.DIM_ID)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new BubblegumTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
         }
         }
}
@SideOnly(Side.CLIENT)
